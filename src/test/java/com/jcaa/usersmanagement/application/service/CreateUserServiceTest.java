...
class CreateUserServiceTest {
  ...
  @Test
  @DisplayName("execute() guarda usuario y notifica cuando el email es nuevo")
  ...
  @Test
  @DisplayName("execute() lanza excepcion cuando el email ya existe")
  ...
  @Test
  @DisplayName("execute() lanza ConstraintViolationException cuando el command es invalido")
